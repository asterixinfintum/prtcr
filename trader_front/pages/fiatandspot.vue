                  ...
                  <div class="assetlist__item fiatandspot" v-for="asset in visibleassets">
                    ...
                    <div class="assetlist__area fiatandspot number-value">
                      <p class="neon-blue">
                        {{
                          asset.btcblc !== 0
                            ? formatNumberForSpecificLocale(asset.btcblc)
                            : `0.00000000`
                        }}
                      </p>
                    </div>
                    ...
                    <div class="assetlist__area fiatandspot assetlist__areabtns">
                      ...
                      <button
                        ...
                        @click.stop="
                          $router.push(
                            `/trader?tradetype=spot&assetid=${asset.assetid}&assettype=${asset.assettype}&assetinitials=${asset.assetinitials}&assetname=${asset.assetname}&userid=${client._id}`
                          )
                        "
                      ...
                      <button
                        ...
                        @click.stop="
                          navigateToTradePage(
                            `trade?autotrader=true&wallet=spot&assettype=${asset.assetType}&baseAsset=${asset.coin}`,
                            asset._id
                          )
                        "
                        v-if="asset.coin !== 'USDT' && asset.coin !== 'USD'"
